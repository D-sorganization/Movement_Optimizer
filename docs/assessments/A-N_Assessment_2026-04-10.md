...
- Commits since 2026-04-09: 5
- Files touched (top 30): 8

<details><summary>Changed files</summary>

- `SPEC.md`
- `assets/movement_optimizer_icon.svg`
- `docs/assessments/A-N_Assessment_2026-04-09.md`
- `model_pack.yaml`
- `pyproject.toml`
- `scripts/__init__.py`
- `scripts/movement_provider_manifest.py`
- `tests/test_movement_provider_manifest.py`
